        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex gap-4 pt-4">
              <Link to="/login" className="px-8 py-4 bg-amber-500 hover:bg-amber-600 text-slate-900 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-[0_0_20px_rgba(245,158,11,0.3)]">
                Access Portal
              </Link>
            </div>
          </div>
          <div className="relative">
            ...
            <img 
              src="/images/excavation_hero.png" 
              alt="Excavation Work" 
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { title: 'Demolition', desc: 'Safe and controlled structure removal.', icon: Clock },
            ].map((s, i) => (
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <img src="/images/welding_work.png" alt="Welding" className="rounded-2xl border border-slate-800 w-full h-[400px] object-cover hover:opacity-90 transition-opacity" />
            <img src="/images/workshop_exterior.png" alt="Workshop" className="rounded-2xl border border-slate-800 w-full h-[400px] object-cover hover:opacity-90 transition-opacity" />
          </div>
        </div>
      </section>
