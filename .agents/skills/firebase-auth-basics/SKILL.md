  ...
  "auth": {
    "providers": {
      ...
      "googleSignIn": {
        ...
        "authorizedRedirectUris": ["https://example.com", "https://localhost"]
      }
    }
  }
}
...
> **CRITICAL**: Do NOT include the protocol or port number in the Authorized Domains list (e.g., use `localhost`, NOT `https://localhost:9090`).
